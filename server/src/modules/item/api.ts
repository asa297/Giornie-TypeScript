  ...
  app.put(
    ...
    async (req: RequestWithUser, res: Response) => {
      try {
        ...
        if (body.item_image_key && item.item_image_key !== '') {
        ...
        await ItemModel.updateOne(
          { _id: docId },
          {
            $set: {
              ...
              item_price: body.item_price,
              item_remark: body.item_remark,
              item_image_url: body.item_image_url ? body.item_image_url : item.item_image_url,
              item_image_key: body.item_image_key ? body.item_image_key : item.item_image_key,
